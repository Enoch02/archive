...
class MainWindow(QWidget):
    ...
    def setUpMainWindow(self):
        ...
        # call methods that contain widgets for each tab
        self.pizzaTab()
        self.wingsTab()
        ...
        # add widgets to the main window and set layout
    ...
    def pizzaTab(self):
        ...
        pizza_desc.setText(
            """<p>Build a custom pizza for you. Start
            with your favorite crust and add any toppings, plus
            the perfect amount of cheese and sauce.</p>s"""
        )
        ...
        # create group box that will contain topping choices
        toppings_gbox = QGroupBox()
        toppings_gbox.setTitle("CHOOSE YOUR TOPPINGS")

        # setup button group for toppings radio buttons
        ...
        # create a button to add information to side widget when clicked
        ...
        page1_v_box.addWidget(
            add_to_order_button1, alignment=Qt.AlignmentFlag.AlignRight
        )
    ...
    def wingsTab(self):
        ...
        page2_v_box.addWidget(
            add_to_order_button2, alignment=Qt.AlignmentFlag.AlignRight
        )
    ...
    def displayPizzaInOrder(self):
        """Collect text from radio buttons that are
        checked in pizza page. Display text in side widget"""
        if self.crust_group.checkedButton():
            ...
            toppings_str = "\n".join(toppings)
            self.display_pizza_label.setText(toppings_str)
            self.update()  # ensure the text is updated

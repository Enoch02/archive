...
class NewUserDialog(QDialog):
    ...
    def setUpWindow(self):
        ...
        user_image = "./registration-login-gui/images/new_user_icon.png"
    ...
    def confirmSignUp(self):
        """Check if user information is correct and appends
        username and password to a text file."""
        ...
        if name_text == "" or pswd_text == "":
            ...
            with open("./registration-login-gui/files/users.txt", "a+") as f:
                f.write("\n" + name_text + " ")
                f.write(pswd_text)
            self.close()

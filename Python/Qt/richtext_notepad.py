...
class MainWindow(QMainWindow):
    ...
    def saveToFile(self):
        """Save text to a file or rich text file"""
        opt = QFileDialog.Option.DontUseNativeDialog
    ...
    def searchText(self):
        ...
        if ok:
            ...
            while self.text_edit.find(find_text):
                # use ExtraSelection() to mark text being searched for as gray
    ...
    def chooseFontColor(self):
        """Select a font from QColorDialog"""
    ...
    def aboutDialog(self):
        ...
        QMessageBox.about(
            self,
            "About Notepad",
            """<p>Notepad demo from Beginner's Practical Guide to PyQt</p>
            <p>
                <em>HTML tags work</em>
            </p>
            <ul>
                <li>Important stuff</li>
                <li>More Important stuff</li>
            </ul>
            """,
        )

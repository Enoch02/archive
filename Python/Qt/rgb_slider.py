...
from PyQt6.QtGui import QImage, QPixmap, QColor, qRgb, QFont, QMouseEvent
...
class RGBSlider(QWidget):
    ...
    def setUpMainWindow(self):
        # image that displays current color set
        # by sliders/spin_box values
    ...
    # create new color based on changes to RGB values
    ...
    def updateColorInfo(self, color):
        """Update the color displayed in image and set the hex values"""
    ...
    def getPixelValues(self, event: QMouseEvent):
        """Reimplements the mousePressEvent method. To use,
        set a widget's mousePressEvent equal to getPixelValues, like so:
        ...
        # valid() returns true of the point selected is a valid
        # coordinate pain within the image
